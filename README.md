...
- [dhinojosa/oreilly-spec-driven-development](https://github.com/dhinojosa/oreilly-spec-driven-development/blob/main/AGENTS.md)
...
- A secondary goal of this project is to explore the benefits and limits of agentic coding. The first version has been generated with JetBrains Junie. The ongoing development is done using Claude Code with LLMs provided by the [adesso ai hub](https://www.adesso.de/en/technologies/adesso-business-cloud/ai-hub.jsp).
