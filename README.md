...
- A secondary goal of this project is to explore the benefits and limits of agentic coding. The original proof-of-concept has been generated with JetBrains Junie and the directly provided models. The ongoing development is done using JetBrains Junie and Claude Code, using LLMS via the local models from the [adesso ai hub](https://www.adesso.de/en/technologies/adesso-business-cloud/ai-hub.jsp) and JetBrains AI. The agents are requested to auto-commit their changes. So, the parts of the code that have been auto-generated by which agent using which LLM can be tracted back in the commit history of the pull requests.
