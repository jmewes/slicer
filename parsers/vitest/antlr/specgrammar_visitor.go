...
type SpecGrammarVisitor interface {
	...
	// Visit a parse tree produced by SpecGrammarParser#modifier.
	VisitModifier(ctx *ModifierContext) interface{}

	// Visit a parse tree produced by SpecGrammarParser#dataGroup.
	VisitDataGroup(ctx *DataGroupContext) interface{}
