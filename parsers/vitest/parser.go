...
// SupportedExtensions lists the file suffixes this parser handles when
// walking a directory of source files.
...
// ParseSpecFile reads a Vitest spec/test file and converts its
// describe/it/test/beforeEach/beforeAll structure into GherkinDocuments. It
// uses an ANTLR-generated parser (see parsers/vitest/antlr/SpecGrammar.g4)
// driving a small tree visitor that emits a *frame tree, which the emitter
// turns into GherkinDocuments.
